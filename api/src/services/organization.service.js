...
const createOrganization = async (organizationData, inviteCode) => {
    ...
    try {
        ...
        const { name, social_name, description, identification_code } = organizationData;
        const orgResult = await client.query(
            'INSERT INTO organization (name, social_name, description, identification_code) VALUES ($1, $2, $3, $4) RETURNING *',
            [name, social_name, description, identification_code]
        );
